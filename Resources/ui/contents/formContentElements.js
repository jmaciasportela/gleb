...
exports.formContentView = function(content) {
    ...
    for (i in content) {
        ...
        var name = item.name || '';
        var labelH1 = item.labelH1 || '';
        var textDefaultValue = item.defaultValue || '';
        var numberDefaultValue = item.defaultValue || 1;
	        ...
	        switch (item.type)
	        {
	            ...
	            case 'textField':
	                ...
	                textField = Ti.UI.createTextField({
	                        ...
	                        keyboardType: keyboardMap[dataType],
	                        passwordMask: dataType === exports.TYPE_PASSWORD,
	                        typeField: item.type
	                    }); 
	            ...
	            case 'selectOption':
	                ...
	                Ti.API.debug('GLEB FORMULARIO - OPTIONS' + JSON.stringify(options));
	                
	                result.push(insertTitle(name));
	                
	                var arrayOptions = [];
	                arrayOptions.push('Cancelar');         
	                JSON.parse(JSON.stringify(options), function (key, value) { if (typeof value === 'string') arrayOptions.push(value);});
	                
	                var selectedOption = numberDefaultValue || 1;
	            ...
	            case 'button':
	                ...
	                button = Ti.UI.createButton({
	                        ...
	                        borderWidth: 1,
	                        borderRadius: 2,
	                        url: url || require("clients/glebAPI.config").sendForm_url,
	                        typeField: item.type
	                    });     
